...
public class parser_transitive_types extends AbstractYagoParser{
	...
	List<String> musicians_list = new ArrayList<String>();
	List<String> scientists_list = new ArrayList<String>();
	List<String> politians_list = new ArrayList<String>();
	List<String> athletes_list = new ArrayList<String>();
	List<String> actors_list = new ArrayList<String>();

	public parser_transitive_types(String filepath) {
		super(filepath);
